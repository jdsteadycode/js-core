#### **🔥 DAY 11: Optimizing Decision Making in JavaScript 🎯**

This project dives into **optimizing decision-making** in JavaScript using `else if` and `else` statements to improve efficiency and execution speed. 🚀

---

## 📌 Contents

- **`else if` & `else` Statements** – Improve decision-making logic.
- **IF-ELSE IF-ELSE Block** – A single conditional execution block.
...
**3️⃣** The `if-else if-else` block categorizes users based on age:
...
Enter Age? 30
NAME: Arun & AGE: 30
Alex is a working professional and he/she is learning JavaScript!
```

## **📂 Files**

- `index.html` → Introduces `else-if` & `else` Statement.
- `script.js` → Contains optimized code for decision-making using `if-else if-else`.
